  ...
  try {
    ...
    for (const founder of founders) {
      try {
        ...
        const quote = await generateMotivationalQuote("afternoon");

        // Send afternoon email with entry ID in subject and motivational quote
        await sendMoodCheckEmail(founder.email, founder.name, "afternoon", moodEntry.id, quote);
